...
//{
//	_typeMapping[SimpleRTTR::types().get_type<int>().value().type_index()] = PropertyTypeHelper<int>::createProperty;
//	_typeMapping[SimpleRTTR::types().get_type<bool>().value().type_index()] = PropertyTypeHelper<bool>::createProperty;
//	_typeMapping[SimpleRTTR::types().get_type<std::string>().value().type_index()] = PropertyTypeHelper<std::string>::createProperty;
//}
//
