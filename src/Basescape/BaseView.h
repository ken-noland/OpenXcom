...
private:
	...
	bool _blink;
	Timer *_timer;
	uint8_t _redColor, _yellowColor, _greenColor;
	bool _highContrast;
	uint8_t _cellColor, _selectorColor;
...
public:
	...
	void setOtherColors(uint8_t red, uint8_t yellow, uint8_t green, bool highContrast);
};
