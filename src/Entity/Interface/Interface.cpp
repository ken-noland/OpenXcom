...
entt::handle InterfaceFactory::createText(const CreateTextParams& params)
{
	...
	entt::handle text = entt::handle(_ecs.getRegistry().raw(), _ecs.getRegistry().raw().create());
	return text;
}
...
entt::handle InterfaceFactory::createTextButton(const CreateTextButtonParams& params)
{
	...
	entt::handle button = entt::handle(_ecs.getRegistry().raw(), _ecs.getRegistry().raw().create());
	return button;
}
...
entt::handle InterfaceFactory::createWindow(const CreateWindowParams& params)
{
	...
	entt::handle window = entt::handle(_ecs.getRegistry().raw(), _ecs.getRegistry().raw().create());
	return window;
}
