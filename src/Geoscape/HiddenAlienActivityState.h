...
public:
	HiddenAlienActivityState(GeoscapeState* state, SavedGame& save, std::unordered_map<entt::entity, int> displayHiddenAlienActivityRegions, std::unordered_map<entt::entity, int> displayHiddenAlienActivityCountries);
