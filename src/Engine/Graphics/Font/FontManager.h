...
public:
	...
	OwningHandle<Font> load(const std::string& name, const FontSettings& settings, std::vector<OwningHandle<DeviceImage>> texture, const std::array<Glyph, 128>& asciiGlyphs, const std::unordered_map<char32_t, Glyph>& extendedGlyphs = {});
